...
require_once __DIR__ . '/InstagramScraper/Unirest/Request.php';
require_once __DIR__ . '/InstagramScraper/Unirest/Method.php';
require_once __DIR__ . '/InstagramScraper/Unirest/Response.php';
