...
<div class="rex-addon-output">
    <h2 class="rex-hl2">Twitter</h2>
    <div class="rex-addon-content">
        <p class="rex-tx1">Twitter kann entweder per API oder Widget eingebunden werden.</p>
        ...
        <p class="rex-tx1">Nähere Informationen zum Widget unter: <a target="_blank" href="https://dev.twitter.com/web/embedded-timelines">Twitter Embedded Timeline</a></p>
    </div>
	<div class="rex-form">
